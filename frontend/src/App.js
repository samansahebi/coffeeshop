...
function App() {
    ...
    return (
        <div className="App">
            ...
            <div>
                <div
                    className='flex fixed items-center bottom-0 w-full h-14 bg-[#111416] rounded-t-lg z-50 border-t border-[#7B7B7B]'>
                    ...
                    <div onClick={() => navigate('/checkout')}
                         className='flex w-full justify-center p-2 m-1 rounded-md'>
                ...
                <Routes>
                    ...
                    {access ? <Route exact path="profile" element={<Profile/>}/> : <Route exact path="profile" element={<Login/>}/>}
